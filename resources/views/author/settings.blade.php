							                            ...
							                            @method('PUT')
							                                ...
							                                <div class="row clearfix">
							                                    ...
							                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
							                                        <div class="form-group">
							                                            <div class="form-line">
							                                                <input type="text" id="email_address_2" class="form-control" placeholder="Enter your email address" name" name="email" value="{{ Auth::user()->email }}">
							                                            </div>
							                                        </div>
							                                    </div>
							                                </div>
							                            ...
							                            @method('PUT')
							                                 ...
							                                 <div class="row clearfix">
							                                    ...
							                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
							                                        <div class="form-group">
							                                            <div class="form-line">
							                                                <input type="password" id="comfirm_password" class="form-control" placeholder="Enter your new password again" name="password_confirmation">
							                                            </div>
							                                        </div>
							                                    </div>
							                                </div>
